...
**Software Engineer** focused on building scalable backend and AI-powered systems, including production-ready applications, semantic retrieval platforms, asynchronous pipelines and multi-agent workflows.
...
**A real-time city and traffic intelligence system that aggregates live data and enables natural language queries over city events, powering an interactive map with up-to-date incident insights**
